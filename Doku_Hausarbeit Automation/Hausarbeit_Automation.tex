...
\addbibresource{literature/Automation_Patrik.bib} %% Einbinden mehrerer bib-Dateien mit zusätzlichem \addbibresource - Befehl
\addbibresource{literature/Hausarbeit-Automation-Simon.bib}
...
\newcommand{\titel}{Optimierung eines Lagers }
\newcommand{\untertitel}{durch ein automatisiertes Hochregallager mit ERP-Anbindung}
\newcommand{\arbeit}{Hausarbeit Automationssysteme}
\newcommand{\studiengang}{Elektrotechnik}
\newcommand{\studienrichtung}{Automation}
\newcommand{\studienschwerpunkt}{}
\newcommand{\autor}{Simon Gschell / Patrik Peters}
\newcommand{\bearbeitungszeitraum}{21.10.2024 - 20.12.2024}
\newcommand{\matrikelnr}{4995162/8379878}
\newcommand{\kurs}{TEA 22}
%\newcommand{\firma}{Name des Dualen Partners (entfällt ggf. bei Studienarbeit)}
\newcommand{\abgabe}{\today}
\newcommand{\betreuerfirma}{Dipl. Ing. Heike Schatton-Beck}
...
\include{chapter/Benefits}
\include{chapter/Vorgehensweise}
\include{chapter/Risiken}
\include{chapter/Kosten}
\include{chapter/Innovationsgrad}
